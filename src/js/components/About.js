  ...
  return (
    <section id="about" className="columnsContainer">
      <div className="leftColumn">
        ...
        <p>The "cineforum itinerant", a cycle of meetings in which a debate is followed by the screening of a film.</p>
        <p>The "brunch-drawing", a drawing group to create individually or together around a good brunch.</p>
        <p>The "literature cafe", a monthly meeting to share impressions, thoughts, and insights after reading some Swiss books.</p>
        <p>I taught photography at the <a href="https://www.flickr.com/photos/espacemozaik/" target="_blank" rel="noopener noreferrer">Espace Mozaik</a>, helping migrants to integrate and to find creative ways to express themselves.</p>
      </div>
      <div className="rightColumn">
        <p className="titleParagraph">Education</p>
        <p>Master's Degree in Interaction / Media Design, Haute Ecole d'Art et de Design, Geneva, Switzerland.</p>
        <p>Master's Degree in Computer Engineering, Swiss Federal Institute of Technology, Lausanne, and at the University of Siena, Italy.</p>
        <p>Bachelor's Degree in Computer Engineering, Politecnico di Milano, Italy.</p>
        ...
        <p> 
          <a href="docs/rovescalli_cv.pdf">English</a> - <a href="docs/rovescalli_cv_ita.pdf">Italiano</a> - <a href="docs/rovescalli_cv_fr.pdf">Francais</a>
        </p>
      </div>
    </section>
  );
